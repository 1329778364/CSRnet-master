...
def CrowdNet():
    ...
    if (batch_norm):
        ...
        model.add(Conv2D(64, kernel_size=kernel, activation='relu', padding='same', input_shape=(rows, cols, 3),
...
# %%
save_mod(model, "weights/wlq_model_A_weights.h5", "models/wlq_Model.json")